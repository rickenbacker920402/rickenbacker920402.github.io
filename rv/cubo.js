...
forma.faces.push( new THREE.Face3( 8, 7, 6) );
forma.faces.push( new THREE.Face3( 5, 1, 7) );
forma.faces.push( new THREE.Face3( 7, 3, 5) );
forma.faces.push( new THREE.Face3( 5, 1, 2) );
forma.faces.push( new THREE.Face3( 5, 6, 1) );
forma.faces.push( new THREE.Face3( 6, 8, 2) );
forma.faces.push( new THREE.Face3( 8, 4, 6) );
forma.faces.push( new THREE.Face3( 8, 7, 3) );
forma.faces.push( new THREE.Face3( 8, 4, 3) );
